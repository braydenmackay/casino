...
def cash_out():
  confirm = input("Are you sure you want to cash out? (Y)es or (N)o ").upper()
  if confirm == 'Y':
    print(f"Thank you for coming to the casino today! Your wallet's balance is ${sum(my_wallet):.2f}. See you again soon!")
  elif confirm == 'N':
    players_option()
  else:
